    ...
    <div class="relative z-50" aria-labelled-by="slide-over-title" role="dialog" aria-modal="true">
      ...
      <div class="pointer-events-auto w-screen max-w-md">
        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl ">
          ...
          <div className="bg-white flex items-center justify-between p-6 border-b-2">
          ...
          <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
            <div class="flex justify-between text-base font-medium text-gray-900">
              <p>Subtotal</p>
              <p>Rs.{Object.values(tempData).reduce((total, product) => {
                const unit = parseInt(product.count, 10) || 0; // Fallback to 0 if count is invalid
                const productTotal = product.price * unit; // Calculate price for this product
                return total + productTotal; // Keep total as a number
              }, 0).toFixed(2)}
              </p>
            </div>
