...
function Modal(props) {
  ...
  useEffect(() => {
    props.formData ? setTempData(props.formData) : setTempData({})
  }, [props.formData])
      ...
      {preLoader ? <PageChange /> :
        <div className="relative w-auto mx-auto max-w-4xl">
          ...
          <section className="flex flex-col items-center pt-6  ">
            <div data-tour="modal-products" className="min-w-[350px] md:min-w-[400px] bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
