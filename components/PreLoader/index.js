...
export default function PageChange(props) {
  return (
    <div className="justify-center items-center bg-white bg-opacity-30 flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="flex items-center justify-center h-screen  w-screen backdrop-blur-sm ">
        <div className="my-32 mx-auto w-[200px] text-center flex flex-col items-center justify-center relative z-50 top-0">
