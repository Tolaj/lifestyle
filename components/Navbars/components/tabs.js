                ...
                <div className="w-full mx-auto items-center justify-between flex md:flex-nowrap flex-wrap md:px-10 px-4">
                    ...
                    <div className="md:hidden text-black text-lg uppercase font-bold flex justify-between w-full md:w-fit">
                        ...
                        <div className='flex gap-2'>
                            <div data-tour='group-btn' onClick={() => _as.setModalToggle('/admin/group')} className=" text-xs flex items-center bg-white text-black shadow-sm rounded-2xl px-3 py-1 hover:shadow-none" >
                            ...
                            <div data-tour='cart-btn' onClick={() => _as.setModalToggle('/admin/cart')} className=" text-xs flex items-center bg-white text-black shadow-sm rounded-2xl px-3 py-1 hover:shadow-none" >
                                <svg
