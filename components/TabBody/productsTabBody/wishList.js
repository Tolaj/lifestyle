                        ...
                        <InputFields.GridButton title="Add to cart" type="ADD_CART"  
                            onClick={() => {
                              ...
                              .then(data => {
                                ...
                                if(localStorage.getItem("projectLifestyle_cart_"+localStorage.getItem('projectLifestyle_activeGroup')).length > 0){
                                  alert("Don't make me say this again. Cart needs to be empty you dumbass!")
                                }else{
