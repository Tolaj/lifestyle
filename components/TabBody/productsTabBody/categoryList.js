...
function CategoryList(props) {
  ...
  if(windowWidth<700){
    return(<>
      <SmCardBody columns = {['name','description','color','icon']}  _as = {props._as} gridApi = "http://localhost:8081/api/categories" />
    </>)
  }else{
    ...
    return (<>
      <GridBody columns = {['name','description','color','icon']} columnComponents = {['','',columnComponentColor,columnComponentIcon]}   _as = {props._as} gridApi = "http://localhost:8081/api/categories" />
    </>);
  }
