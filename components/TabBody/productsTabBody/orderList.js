// components/TabBody/productsTabBody/orderList.js
...
function OrderList(props) {
  ...
  const columnComponentItems = (params) => {
    ...
    return (<>
      <div onClick={() => { setShowItems(showItems === params.data._id ? null : params.data._id) }}
        className='w-full h-6 border-2 rounded-xl my-1 hover:bg-gray-100 flex items-center justify-center'>
